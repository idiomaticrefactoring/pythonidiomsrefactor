...
'''
   ...
   #
   #  util.save_csv(util.data_root+"idiom_code_dir_star_1000/multi_assign_idiom_code_sample.csv",result_compli_for_else_list[:377],["repo_name","code","num_vars","file_html","file_path"])
    #'''
    files_num_list = []
    star_num_list = []
