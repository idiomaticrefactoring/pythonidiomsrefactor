...
'''
    ...
    # util.save_csv(util.data_root+"idiom_code_dir_star_1000/chained_comparison_idiom_code.csv",result_compli_for_else_list,["repo_name","code","line_no","file_html","file_path"])
