...
def pip_install(pro_path,v):
    ...
    cmd_pip_pack = ["echo '", split_install, "' ;","sudo apt-get install python3.",v,"-dev;pip3 install pytest pytest-mock requests yarg pytest-cov; python3 /mnt/zejun/smp/code/test_case/pipreqs.py; "]
    #'''
