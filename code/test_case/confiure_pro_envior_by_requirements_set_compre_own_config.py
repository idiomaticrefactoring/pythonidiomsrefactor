...
def make_pytest_test(pro_path, relative_test_file_path, file_name,v, fun_list=[]):
    ...
    if 1:  # len(set(whether_same))==len(whether_same):#https://github.com/nodejs/node-gyp/tree/master/gyp/pylib/gyp/input_test.py
...
if __name__ == '__main__':
    ...
    for file_name in os.listdir(save_me_test_me_dir):
        ...
        repo_list.append([repo_name, save_me_test_me_dir, save_test_file_res_dir,util.ven_name])
        # if os.path.exists(save_me_test_me_dir + repo_name + ".pkl"):
