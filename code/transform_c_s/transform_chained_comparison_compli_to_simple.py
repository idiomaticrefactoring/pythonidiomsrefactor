...
def transform_left_right(pos1, pos2, node1, node2):
    code = ""
    if pos1 == 'r' and pos2 == 'l':  # 
        code = merge(node1, node2)
        # print("c->s: ", code)
        pass
    elif pos1 == 'l' and pos2 == 'r':  # 
        code = merge( node2,node1)
        pass
    elif pos1 == 'l' and pos2 == 'l':  # 
        # change node1
        ...
        if isinstance(node1.ops[-1],(ast.NotIn,ast.In)) and isinstance(node2.ops[-1],(ast.NotIn,ast.In)) :
            ...
            #print("come here")
            new_node = change_compare_node(node1) # change 
...
#a>1  and  direc.lower() in a 
#1<a  and  direc.lower() in a 
#1<a  and  a in direc.lower() 
#b in a  and  a in direc.lower()  
